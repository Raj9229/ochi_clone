...
import { FaTwitter, FaLinkedin, FaInstagram, FaGithub, FaArrowUp } from 'react-icons/fa'
...
const Footer = () => {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.1" className="bg-zinc-900 text-white border-t border-zinc-800">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <div className="w-10 h-10 bg-zinc-800 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors">
                <FaTwitter />
              </div>
              <div className="w-10 h-10 bg-zinc-800 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors">
                <FaLinkedin />
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <a href="mailto:hello@ochi.design" className="text-white hover:text-green-400 transition-colors">
                  hello@ochi.design
                </a>
              </div>
              <div>
        ...
        <div className="mt-16 pt-8 border-t border-zinc-800">
          <div className="max-w-2xl">
            ...
            <p className="text-zinc-300 mb-6">
              Subscribe to our newsletter for the latest insights and design trends.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-400 focus:outline-none focus:border-green-500"
              />
      ...
      {/* Bottom Bar */}
      <div className="border-t border-zinc-800 px-20 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-zinc-400 text-sm">
            © {currentYear} Ochi Design. All rights reserved.
          </div>
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            <button
              onClick={scrollToTop}
              className="w-10 h-10 bg-zinc-800 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"
            >
              <FaArrowUp />
            </button>
          </div>
